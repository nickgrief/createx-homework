...
export class ChartsLoaderService {
  ...
  private summarizeData(): Observable<
    Map<
      string,
      { orders: number; new: number; delivered: number; returned: number }
    >
  > {
  ...
  public getSumData(): Observable<OfficeChartData> {
    return this.summarizeData().pipe(
      map((data) =>
            ...
            prev.set(curr.src_office_id, <OfficeChartData>{
              ...
              datasets: [
                <OfficeChartDataset>{
                  ...
                  data: [
                    ...previousData.datasets[0].data,
                    String(curr.qty_orders),
                  ],
                ...
                <OfficeChartDataset>{
                  ...
                  data: [
                    ...previousData.datasets[2].data,
                    String(curr.qty_delivered),
                  ],
                ...
                <OfficeChartDataset>{
                  ...
                  data: [
                    ...previousData.datasets[3].data,
                    String(curr.qty_return),
                  ],
